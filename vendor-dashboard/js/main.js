...
$(document).ready(function(){
    $('.mobile_maij').click(function(){
      $(".leoal-sec-l").toggleClass("show-leoal-sec-l");
      $(".mobile_maij").toggleClass("show-mobile_maij_span");
    });
  });


$(document).ready(function(){
    $('.leoal-sec-l ul li a').click(function(){
      $(".leoal-sec-l").removeClass("show-leoal-sec-l");
      $(".mobile_maij").removeClass("show-mobile_maij_span");
    });
  });
